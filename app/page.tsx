          ...
          <div className="flex items-center justify-between">
              ...
              <div>
                {editingParafiaNazwa ? (
                  ...
                  <div className="flex items-center gap-2">
                    <h1 className="text-sm sm:text-xl font-bold truncate max-w-[130px] sm:max-w-none">{currentParafia?.nazwa}</h1>
                    {currentUser.typ === 'ksiadz' && (
            ...
            {currentUser.typ === 'ksiadz' && currentParafia && (
              <div className="flex items-center gap-1 md:gap-2">
                ...
                <code className="text-xs md:text-lg font-bold bg-gray-100 dark:bg-gray-700 px-1.5 md:px-2 py-0.5 md:py-1 rounded">
